...
<ul class="timeline">
	...
	<li class="content__section content__main">
        ...
        <span class="image-container">
            ...
            <span class="project-description">
            After securing a first place in the MLML competition, I was invited by the TA to join his team for the IDAO competition organized <span style="text-color:red">Y</span>andex, which focused on 
            </span>
        </span>
		<h2 class="content__text">Robotics, AI & CV</h2>
	</li>
