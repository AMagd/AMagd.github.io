	...
	<li class="content__section content__main">
        ...
        <span class="image-container">
            <span class="horizontal-image-cover" style="background-color:white">
                ...
                <img src="assets/css/timeline_media/sesc-min.png" alt="blast" style="object-fit:contain; border:2px solid black">
                <img src="assets/css/timeline_media/pub3.png" alt="blast" style="object-fit:contain; border:2px solid black">
                <img src="assets/css/timeline_media/pub4.png" alt="blast" style="object-fit:contain; border:2px solid black">
            </span>
            <span class="project-description">
            ...
            <ul>
            <li>1st project: Experimental modeling of hexapod robot using artificial intelligence, published at AICV 2020</li>
            <li>2nd project: Classifying upper limb activities using deep neural networks</li>
            <li>3rd project: Neuro-Fuzzy System for 3-DOF Parallel Robot
            Manipulator, published at NILES 2019</li>
            </ul>
            <b><u>What was learnt:</u></b>
            <ul>
            <li>Experience working with RGBD sensors like Kinect and IMU sensors</li>
