...
<p align="center">
<img src="{{ '/assets/project_media/Thesis/diff1.gif' | prepend: site.baseurl }}" style="width:50px;" class="center" />
<img src="{{ '/assets/project_media/Thesis/diff2.gif' | prepend: site.baseurl }}" style="width:50px;" class="center" />
<img src="{{ '/assets/project_media/Thesis/diff3.gif' | prepend: site.baseurl }}" style="width:50px;" class="center" />
<img src="{{ '/assets/project_media/Thesis/diff4.gif' | prepend: site.baseurl }}" style="width:50px;" class="center" />
</p>
