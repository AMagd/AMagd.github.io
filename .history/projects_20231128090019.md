...
<div style="text-align: center;">
  ...
  <!-- Path for the first pair of gifs -->
  <div style="position: relative; display: inline-block;">
    <span style="color: #colorA;">A</span>→<span style="color: #colorB;">B</span>→<span style="color: #colorC;">C</span>→<span style="color: #colorD;">D</span>→<span style="color: #colorA;">A</span>
    <div>
  ...
  <!-- Path for the second pair of gifs -->
  <div style="position: relative; display: inline-block;">
    <span style="color: #colorA;">A</span>→<span style="color: #colorB;">B</span>→<span style="color: #colorC;">C</span>→<span style="color: #colorC;">C</span>→<span style="color: #colorD;">D</span>→<span style="color: #colorA;">A</span>
    <div>
