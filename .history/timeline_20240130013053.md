	...
	<li class="content__section content__main">
        ...
        <span class="image-container">
            <span class="horizontal-image-cover" style="background-color:#40ba21">
                ...
                <img src="assets/project_media/path_planning.png" alt="uav localization project" style="object-position:right buttom; border:2px black solid; object-fit:cover; clip-path: inset(20px 50px 10px 0 round 50px)">
            </span>
            <span class="project-description">
