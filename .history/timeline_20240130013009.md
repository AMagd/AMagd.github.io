	...
	<li class="content__section content__main">
        ...
        <span class="image-container">
            <span class="horizontal-image-cover" style="background-color:#40ba21">
                ...
                <img src="assets/project_media/path_planning.png" alt="uav localization project" style="object-position:right buttom; border:2px black solid; object-fit:contain; transform: scale(0.5) translate(0, 5%)">
            </span>
            <span class="project-description">
