...
## [2023] Deep RL: Diffusion Models for HD Mapping
...
<p align="center">
<img src="{{ '/assets/project_media/Thesis/architecture.png' | prepend: site.baseurl }}" style="width:100px;" class="center" />
<!-- <img src="{{ '/assets/project_media/BLAST/small_agent.gif' | prepend: site.baseurl }}" style="width:100px;" class="center" />
<img src="{{ '/assets/project_media/BLAST/color_direction.gif' | prepend: site.baseurl }}" style="width:100px;" class="center" />
<img src="{{ '/assets/project_media/BLAST/random_frames.gif' | prepend: site.baseurl }}" style="width:100px;" class="center" />
<img src="{{ '/assets/project_media/BLAST/video.gif' | prepend: site.baseurl }}" style="width:100px;" class="center" /> -->
...
Qualitative Results:
<p align="center">
<img src="{{ '/assets/project_media/Thesis/input_output.png' | prepend: site.baseurl }}" style="width:100px;" class="center" />
</p>
<p align="center">
<img src="{{ '/assets/project_media/Thesis/diff1.gif' | prepend: site.baseurl }}" style="width:100px;" class="center" />
<img src="{{ '/assets/project_media/Thesis/diff2.gif' | prepend: site.baseurl }}" style="width:100px;" class="center" />
<img src="{{ '/assets/project_media/Thesis/diff3.gif' | prepend: site.baseurl }}" style="width:100px;" class="center" />
<img src="{{ '/assets/project_media/Thesis/diff4.gif' | prepend: site.baseurl }}" style="width:100px;" class="center" />
</p>
