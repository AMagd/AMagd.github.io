...
<ul class="timeline">
    <li class="content__section content__main">
		...
		<span class="image-container">
            ...
            <b><u>Details:</u></b>
            <!-- Have thorough and extensive experience about the theory and code of Diffuser (Project details cannot be discoled)<br/> -->
            Enhance the performance Diffuser (Project details and idea cannot be discoled)<br/>
            <b><u>What was learnt:</u></b>
            <ul>
            <li>Extensive theoritical and practical experience gained from getting my hands dirty with Diffuser code and other codes as well that were utilized to enhance Diffuser's performance</li>
            <li>Using diffusion models for RL tasks</li>
            <li>Working on offline RL planning</li>
            <li>Working with D4RL environments</li>
            </ul>
            </span>
        </span>
    ...
    <li class="content__section content__main">
        ...
        <span class="image-container">
            ...
            <span class="project-description">
            <b><u>Details:</u></b>
            Working on projects related to long-term memory in model-based RL. Have thorough experience working on S4WM code<br/>
            <b><u>What was learnt:</u></b>
            <ul>
            <li>Extensive theoritical and practical experience gained from working on S4WM and the idea used to improve it's performance</li>
