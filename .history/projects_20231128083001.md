...
<div style="display: flex; justify-content: center; align-items: flex-start;">
  <!-- Existing image with adjusted width -->
  <img src="{{ '/assets/project_media/S4WM/results.png' | prepend: site.baseurl }}" style="width:300px; display: block; margin-right: 20px;" />

  <!-- New table with borders and padding -->
  <table style="border-collapse: collapse; border: 1px solid black;">
    <tr>
      <th style="border: 1px solid black; padding: 5px;">Measurement/model</th>
      <th style="border: 1px solid black; padding: 5px;">S4WM</th>
      <th style="border: 1px solid black; padding: 5px;">Improved WM</th>
    </tr>
    <tr>
      <td style="border: 1px solid black; padding: 5px;">Test reconstruction MSE</td>
      <td style="border: 1px solid black; padding: 5px;">1.6749</td>
      <td style="border: 1px solid black; padding: 5px; color: green;">✅ 1.5234</td>
    </tr>
    <tr>
      <td style="border: 1px solid black; padding: 5px;">Test generation MSE</td>
      <td style="border: 1px solid black; padding: 5px;">44.2629</td>
      <td style="border: 1px solid black; padding: 5px; color: green;">✅ 26.5459</td>
    </tr>
  </table>
</div>
