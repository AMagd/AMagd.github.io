...
<ul class="timeline">
    <li class="content__section content__main">
		...
		<span class="image-container">
            ...
            <bu>What was learnt:<bu>
            <ul>
            <li>Extensive experience gained from getting my hands dirty with Diffuser code and other codes as well that were used to enhance Diffuser's performance</li>
