...
<ul class="timeline">
	...
	<li class="content__section content__main">
        ...
        <span class="image-container">
            ...
            <span class="project-description">
                <b><u>Details: enrolled in 2-years FESTO professional diplome as FACT center in Nile University, it's focused on developing industry relevant knowledge in the robotics field throught the following courses: 
