...
<ul class="timeline">
	...
	<li class="content__section content__main">
        ...
        <span class="image-container">
            <span class="horizontal-image-cover" style="background-color:#6f6f6f">
                <img src="assets/css/timeline_media/rl_book.jpeg" alt="blast" style="border:1px black solid">
                <img src="assets/css/timeline_media/openai_spinning_up.png" alt="blast" style="object-position:left border:1px black solid">
                <img src="assets/css/timeline_media/deepmind_x_ucl.png" alt="blast" style="border:1px black solid">
                <!-- <img src="assets/css/timeline_media/blast_cup_catch.gif" alt="blast"> -->
            </span>
            <span class="project-description">
	...
	<li class="content__section content__main">
        ...
        <span class="image-container">
            <span class="horizontal-image-cover" style="background-color:#6f6f6f">
                <!-- <span class="horizontal-image-cover" style="background-color:#6f6f6f">
                <img src="assets/css/timeline_media/ms_diff1.gif" alt="blast" style="border:1px black solid">
                <img src="assets/css/timeline_media/ms_diff2.gif" alt="blast" style="border:1px black solid">
                <img src="assets/css/timeline_media/ms_diff3.gif" alt="blast" style="border:1px black solid">
                </span> -->
