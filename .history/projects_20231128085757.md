...
<div style="text-align: center;">
  ...
  <!-- Container for the first pair of GIFs with the same path -->
  <div style="position: relative; display: inline-block; margin: 0 10px;">
    <!-- Overlay path for the first pair -->
    <div style="position: absolute; top: 10px; left: 50%; transform: translateX(-50%); color: #color1; font-weight: bold; font-size: 14px;">A→B→C→D→A→B→C→D</div>
    
    <!-- First GIF of the first pair -->
    <img src="{{ '/assets/project_media/S4WM/abcdabcd.gif' | prepend: site.baseurl }}" alt="ABCDABCD Trajectory" style="width:75px;" />
    <div style="color: #color1; font-size: 14px;">S4WM</div>

    <!-- Second GIF of the first pair -->
    <img src="{{ '/assets/project_media/S4WM/abcdabcd_rssm.gif' | prepend: site.baseurl }}" alt="ABCDABCD RSSM Trajectory" style="width:75px;" />
    <div style="color: #color1; font-size: 14px;">RSSM</div>
  </div>
  
  <!-- Container for the second pair of GIFs with the same path -->
  <div style="position: relative; display: inline-block; margin: 0 10px;">
    <!-- Overlay path for the second pair -->
    <div style="position: absolute; top: 10px; left: 50%; transform: translateX(-50%); color: #color2; font-weight: bold; font-size: 14px;">A→B→C→C→D→A</div>
    
    <!-- First GIF of the second pair -->
    <img src="{{ '/assets/project_media/S4WM/abcd.gif' | prepend: site.baseurl }}" alt="ABCD Trajectory" style="width:75px;" />
    <div style="color: #color2; font-size: 14px;">S4WM</div>

    <!-- Second GIF of the second pair -->
    <img src="{{ '/assets/project_media/S4WM/abcd_rssm.gif' | prepend: site.baseurl }}" alt="ABCD RSSM Trajectory" style="width:75px;" />
    <div style="color: #color2; font-size: 14px;">RSSM</div>
  </div>
