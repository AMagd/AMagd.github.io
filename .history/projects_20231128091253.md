...
<div style="text-align: center; display: flex; justify-content: center; align-items: flex-start;">
  ...
  <!-- Container for the first pair of GIFs and trajectory -->
  <div style="display: inline-block; text-align: center; margin-right: 20px;">
    <!-- Trajectory Path -->
    <div>
      <span style="color: #FF0000;">A</span>→<span style="color: #00FF00;">B</span>→<span style="color: #0000FF;">C</span>→<span style="color: #FF00FF;">D</span>
    </div>
    <!-- First Pair of GIFs -->
    <img src="{{ '/assets/project_media/S4WM/abcdabcd.gif' | prepend: site.baseurl }}" alt="ABCDABCD Trajectory" style="width:75px;"/>
    <span style="color: #captionColor;">S4WM</span>
    <img src="{{ '/assets/project_media/S4WM/abcdabcd_rssm.gif' | prepend: site.baseurl }}" alt="ABCDABCD RSSM Trajectory" style="width:75px;"/>
    <span style="color: #captionColor;">RSSM</span>
  </div>
  
  <!-- Vertical Separator Line -->
  <div style="width: 1px; background-color: #CCCCCC; height: 150px; display: inline-block;"></div>

  <!-- Container for the second pair of GIFs and trajectory -->
  <div style="display: inline-block; text-align: center; margin-left: 20px;">
    <!-- Trajectory Path -->
    <div>
      <span style="color: #FF0000;">A</span>→<span style="color: #00FF00;">B</span>→<span style="color: #0000FF;">C</span>→<span style="color: #FF00FF;">D</span>→<span style="color: #FF0000;">A</span>
    </div>
    <!-- Second Pair of GIFs -->
