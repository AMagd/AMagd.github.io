...
<ul class="timeline">
	...
	<li class="content__section content__main">
        ...
        <span class="image-container">
            <span class="horizontal-image-cover" style="background-color:white">
                <img src="assets/css/timeline_media/festo_logo.png" alt="blast" style="object-fit:contain; padding:10px">
            </span>
            <span class="project-description">
	...
	<li class="content__section content__main">
        ...
        <span class="image-container">
            <span class="horizontal-image-cover" style="background-color:#6f6f6f">
                <img src="assets/css/timeline_media/festo_logo.png" alt="blast">
            </span>
            <span class="project-description">
