...
<!-- Ensure your CSS link tag is properly included in the head of your HTML -->
<link rel="stylesheet" type="text/css" href="{{ '/path/to/your/css/style.css' | prepend: site.baseurl }}">

<!-- Content Section -->
<div style="display: flex; flex-wrap: wrap; justify-content: center; align-items: flex-start; gap: 20px;">
  
  <!-- Plot Image -->
  <img src="{{ '/assets/project_media/S4WM/results.png' | prepend: site.baseurl }}" alt="S4WM Results" style="max-width: 100%; height: auto; flex: 1;">
