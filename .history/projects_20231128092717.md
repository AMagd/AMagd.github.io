...
<div style="text-align: center;">
  ...
  <!-- Group for the first pair of GIFs -->
  <div style="display: inline-block; margin: 0 10px;">
    <!-- Trajectory for the first pair of GIFs centered above them -->
    <div style="color: #yourColor; font-size: 14px; text-align: center;">A→B→C→D→A→B→C→D</div>
    ...
    <div>
      <span style="color: #yourColor; font-size: 14px; margin-right: 75px;">S4WM</span>
      <span style="color: #yourColor; font-size: 14px; margin-left: 75px;">RSSM</span>
    </div>
  </div>
  
  <!-- Group for the second pair of GIFs -->
  <div style="display: inline-block; margin: 0 10px;">
    <!-- Trajectory for the second pair of GIFs centered above them -->
    <div style="color: #yourColor; font-size: 14px; text-align: center;">A→B→C→C→D→A</div>
    <div style="position: relative; display: inline-flex; justify-content: center;">
