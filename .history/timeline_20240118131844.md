...
<div class="selector">
	<a href="#birth">4500<strong>Birth of the Earth</strong><div id="image-switcher" onclick="switchImage(this)" 
        data-static="assets/css/timeline_media/robot.png" 
        data-gif="assets/css/timeline_media/robot.gif"></a>
...
<ul class="timeline">
    ...
    <div id="image-switcher" onclick="switchImage(this)" 
        data-static="assets/css/timeline_media/robot.png" 
        data-gif="assets/css/timeline_media/robot.gif">
        <!-- <img id="robot-static" src="assets/css/timeline_media/robot.png" alt="Robot" /> -->
    </div>
    </li>
	<li>
		<h2 id="know"></h2>
