 ...
 */
{
    ...
    function checkElementsOnScroll() {
        ...
        sections.forEach((section, index) => {
            ...
            const middleOfElement = bounds.top;
            const middleOfViewport = window.innerHeight;
            const isInMiddle = middleOfElement > middleOfViewport * 0.45 && middleOfElement < middleOfViewport * 0.55;
