        ...
        if ('IntersectionObserver' in window) {
            ...
            observer = new IntersectionObserver((entries) => {
                ...
                entries.forEach(entry => {
                    console.log(( (entry.intersectionRect.top < 0.6*entry.rootBounds.height) && (entry.intersectionRect.top > 0.4*entry.rootBounds.height) ))
                    if ( (entry.intersectionRect.top < 0.6*entry.rootBounds.height) && (entry.intersectionRect.top > 0.4*entry.rootBounds.height) ) {
