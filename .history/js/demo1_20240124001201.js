 ...
 */
{
    ...
    function checkElementsOnScroll() {
        sections.forEach((section, index) => {
            ...
            const isInMiddle = middleOfElement > middleOfViewport * 0.49 && middleOfElement < middleOfViewport * 0.51;

            if (isInMiddle) {
                console.log("Element in middle:", section);
                console.log("Element in middle:", section.getBoundingClientRect());
