...
<div style="text-align: center;">
  ...
  <!-- Trajectory Path for the first pair of GIFs -->
  <div style="color: #yourColor; font-weight: bold;">
    <span style="color: #colorForA;">A</span>→
    <span style="color: #colorForB;">B</span>→
    <span style="color: #colorForC;">C</span>→
    <span style="color: #colorForD;">D</span>→
    <span style="color: #colorForA;">A</span>
  </div>

  <!-- First Pair of GIFs -->
  <img src="{{ '/assets/project_media/S4WM/abcdabcd.gif' | prepend: site.baseurl }}" style="width:75px;" class="center" />
  <img src="{{ '/assets/project_media/S4WM/abcdabcd_rssm.gif' | prepend: site.baseurl }}" style="width:75px;" class="center" />
  
  <!-- Labels for the first pair of GIFs -->
  <div style="color: #yourColor;">S4WM</div>
  <div style="color: #yourColor;">RSSM</div>

  <!-- Trajectory Path for the second pair of GIFs -->
  <div style="color: #yourColor; font-weight: bold;">
    <span style="color: #colorForA;">A</span>→
    <span style="color: #colorForB;">B</span>→
    <span style="color: #colorForC;">C</span>→
  ...
  <!-- Second Pair of GIFs -->
  <img src="{{ '/assets/project_media/S4WM/abcd.gif' | prepend: site.baseurl }}" style="width:75px;" class="center" />
  <img src="{{ '/assets/project_media/S4WM/abcd_rssm.gif' | prepend: site.baseurl }}" style="width:75px;" class="center" />
  
  <!-- Labels for the second pair of GIFs -->
  <div style="color: #yourColor;">S4WM</div>
  <div style="color: #yourColor;">RSSM</div>
