...
This was a project that builds on top of the paper "S4WM: Facing Off World Model Backbones: RNNs, Transformers, and S4" to improve the imagination of the world model. The gifs below are for an analysis I made to compare the imagination of the world models (S4WM and RSSM). While the model I implemented is a modified version of S4WM, that uses a different architecture for the world model backbone.
