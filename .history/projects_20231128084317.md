...
<p align="center">
<img src="{{ '/assets/project_media/S4WM/abcdabcd.gif' | prepend: site.baseurl }}" style="width:50px;" class="center" />
<img src="{{ '/assets/project_media/S4WM/abcdabcd_rssm.gif' | prepend: site.baseurl }}" style="width:50px;" class="center" />
<img src="{{ '/assets/project_media/S4WM/abcd.gif' | prepend: site.baseurl }}" style="width:50px;" class="center" />
<img src="{{ '/assets/project_media/S4WM/abcd_rssm.gif' | prepend: site.baseurl }}" style="width:50px;" class="center" />
</p>
