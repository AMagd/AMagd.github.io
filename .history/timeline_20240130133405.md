...
<ul class="timeline">
	...
	<li class="content__section content__main">
        ...
        <span class="image-container">
            ...
            <b><u>What was learnt:</u></b>
            <ul>
            <li>Developing practical skills in applying transfer learning to optimize model performance under resource constraints.</li>
            <li>Exploring and implementing cutting-edge techniques like knowledge distillation, ensemble learning, and quantization for model efficiency.</li>
            <li>Innovative problem-solving in domain adaptation, utilizing pseudo labeling and auto-encoders to bridge dataset disparities.</li>
