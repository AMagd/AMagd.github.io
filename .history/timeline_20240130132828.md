...
<ul class="timeline">
	...
	<li class="content__section content__main">
        ...
        <span class="image-container">
            ...
            <span class="project-description">
            My interest in AI was sparked here, particularly during an engaging machine learning course. A pivotal experience was my participation in the Innopolis 2020 ML challenge, centered on domain adaptation. Initially, the performance of my self-designed classification model was hindered by limited computational resources and data. I exploited transfer learning, freezing the initial layers and fine-tuning the model, which significantly enhanced its performance. Further refinement involved advanced techniques such as knowledge distillation, ensemble learning, and quantization, balancing model efficiency with computational demand. I also tackled the domain adaptation challenge by using pseudo labeling and auto-encoders, effectively bridging the gap between training and testing datasets. This approach led me to secure first place in the challenge, proving my self-driven learning and perseverance, especially as a relative beginner in AI compared to my peers. What I have learnt through this experience is more than what I could've learnt simply by taking a course, since I had to learn on my own and do my own research to solve the problem at hand, which is why I consider this experience to be one of the most important ones in my journey.
            </span>
        </span>
		<h2 class="content__text">Robotics, AI & CV</h2>
	</li>
