	...
	<li class="content__section content__main">
        ...
        <span class="image-container">
            <span class="horizontal-image-cover" style="background-color:#40ba21">
                <img src="assets/css/project_media/uav_localization.gif" alt="Innopolis University logo">
            </span>
            <span class="project-description">
            <b><u>Details:</u></b> Proposing a design for a UAV’s landing station that can replace ArUco markers in harsh weather conditions. Then implementing an algorithm that uses this design to localize the UAV in 3D (with different precisions depending on the amount of occlusion on the station)</b>
            <b><u>What was learnt:</u></b>
            <ul>
